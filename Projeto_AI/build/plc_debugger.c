 ...
 * Declare programs 
 **/
extern CONTROLE_SERVO RES0__INSTANCE0;
...
{&(RES0__INSTANCE0.CONTROL), BOOL_ENUM},
{&(RES0__INSTANCE0.START_LED), BOOL_ENUM},
{&(RES0__INSTANCE0.STOP_LED), BOOL_ENUM},
...
{&(RES0__INSTANCE0.ENABLE_CONTROL), BOOL_ENUM}
};
